...
import CompanyIcon from "../../static/company.svg"
...
const Company = () => {
    ...
    return (
        <div>
            ...
            />
            <Drawer
                title={<div style={headerStyle}><Icon component={CompanyIcon}/> Mes Companies</div>}
                placement={"right"}
                closable={true}
                ...
                bodyStyle={bodyStyle}
                >
                <CompanyCard setEditModal={setEditModal} setCallDelete={setCallDelete}/>
            </Drawer>
            {openEditModal && editCompanyModal}
            {callDelete &&
                <DeleteCompany setCallDelete={setCallDelete}/>
            }
        </div>
    )
};
