...
const form = class Form extends React.Component<FormProps & FormComponentProps, IState> {
    ...
    const items = props.items ? props.items : [{id : 'random', content: <p>Error</p>, label: 'Error'}];
    ...
    const {getFieldDecorator} = formProps.form;
        ...
        return (
            <AntForm onSubmit={testOnSubmit} labelAlign={props.labelAlign} layout={props.layout} colon={props.colon}>
                {items.map((item: Item) => {
