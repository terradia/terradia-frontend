    ...
    <ApolloProvider client={client}>
        ...
        <Layout>
            <Header style={{
                ...
                display: 'flex',
                position: 'relative',
                backgroundImage: 'linear-gradient(-90deg, #5ac4b5, #7fbc74)',
                justifyContent: 'space-between'
            }}
            >
                <img rel="shortcut icon" src="/static/Titreblanc.png"
                     style={{maxHeight: '8vh', position: 'absolute', top: '1vh'}} alt={"Terradia"}/>
                <Login/>
            </Header>
            ...
            <Footer style={{height: '10vh', backgroundImage: 'linear-gradient(-90deg, #5ac4b5, #7fbc74)'}}
            >
